...
var (
	cfg = config.Env.ElasticsearchURL
)

func (m *mongoSearchRespository) Elastic(id string) (interface{}, error) {
...
func (m *mongoSearchRespository) IndexDocument(document interface{}, indexName string, id string) (string, error) {
	// Initialize a client with the default settings.
	//
	// An `ELASTICSEARCH_URL` environment variable will be used when exported.
	//
...
func (m *mongoSearchRespository) CreateIndex(name string) (string, error) {
...
func (m *mongoSearchRespository) SearchElastic(indexName string, key string, value string) ([]map[string]interface{}, error) {
	// Initialize a client with the default settings.
	//
	// An `ELASTICSEARCH_URL` environment variable will be used when exported.
	//
	...
	termQuery := elastic.NewMatchPhrasePrefixQuery(key, "*"+value+"*")
