...
func (m *mongoAccountRespository) IndexDocument(document interface{}, indexName string, id string) {
	// Delete Index
...
func (m *mongoAccountRespository) CreateIndex(name string) {
...
func (m *mongoAccountRespository) DeleteIndex(name string, ID string) {
